...
namespace Nerdlabs.Avalonia.Extension.ViewModels
{
    public class MessageBoxViewModel : ViewModelBase
    {
        ...
        public MessageBoxViewModel(MessageBoxOptions @params, MessageBoxWindow wnd)
        {
            if (wnd == null)
            {
            ...
            if (@params.Icon == null)
            {
                @params.Icon = BitmapFactory.Load("avares://Nerdlabs.Avalonia.Extension/Assets/avalonia-logo.ico");
            }
